...
module.exports = {
	...
	async execute(guild) {
		...
		var channel = guild.systemChannelID ? guild.channels.get(guild.systemChannelID) : guild.channels.cache.find((n) =>  n.permissionsFor("928009793099149373").has("SEND_MESSAGES") &&  n.permissionsFor("928009793099149373").has("EMBED_LINKS"));
